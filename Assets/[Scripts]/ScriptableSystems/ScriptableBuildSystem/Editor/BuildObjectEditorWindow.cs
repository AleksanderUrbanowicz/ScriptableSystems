...
public class BuildObjectEditorWindow : EditorWindow
{
    ...
    #region Settings
    string scriptableObjectsPath = "Assets/AutoGeneratedAssets/ScriptableObjects/";
    ...
    private void DrawHeader()
    {
        ...
        defaultObstaclesLayer = EditorTools.LayerMaskField("Default obstacles mask", defaultObstaclesLayer);
        GUILayout.EndArea();
    }
    ...
    private void DrawObjectsGenerator()
    {
        ...
        if (sceneObject != null)
        {
            ...
            {
                string correctPath = "Assets/" + "AutoGeneratedAssets/" + buildObjectData.id + prefabSuffix+".prefab";
    ...
    private void DrawObjectPreview()
    {
        ...
        buildObjectData.obstacleLayers = EditorTools.LayerMaskField("Obstacles Mask: ", buildObjectData.obstacleLayers);
        GUILayout.EndArea();
    }
